...
# rename HGVS columns
calls.all <- calls.all %>% dplyr::rename(hgvs_protein=hgvs_protein.y, hgvs_cdna=hgvs_cdna.y)
calls.all$hgvs_cdna.x <- NULL
calls.all$hgvs_protein.x <- NULL

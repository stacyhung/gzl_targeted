...
calls.all <- read.table("/Volumes/shung/projects/gzl_targeted/target+exome/calls.all-exome+target-snvs_indels-no_UTR.txt", sep = "\t", header = TRUE, stringsAsFactors = FALSE)
...
write.table(calls.all, "/Volumes/shung/projects/gzl_targeted/target+exome/calls.all-exome+target-snvs_indels-no_UTR.maf", sep = "\t", quote = FALSE, row.names = FALSE)

...
varscan.datasets <- c("varscan", 
                      "varscan, strelka", 
                      "varscan, mutect", 
                      "varscan, mutect, strelka")
mutect.datasets <- c("mutect", 
                     "mutect, strelka")
strelka.datasets <- c("strelka")
...
write.table(calls.all, "/Volumes/shung/projects/gzl_targeted/targeted_batch2_20191011/calls.integration/calls.all-union-varscan_mutect_strelka.txt", sep = "\t", row.names = FALSE, quote = FALSE)
```

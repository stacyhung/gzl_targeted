...
sample.data <- sample.data[, c("tumor.target_ID", "tumor_content", "normal.extraction_method")]
colnames(sample.data) <- c("tumor_id", "tumor_content", "normal.extraction_method")

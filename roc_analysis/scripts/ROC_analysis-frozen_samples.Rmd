...
samples.frozen <- read.table("/Volumes/shung/projects/gzl_targeted/roc_analysis/data/frozen_samples.txt", header = FALSE)
samples.ffpe <- read.table("/Volumes/shung/projects/gzl_targeted/roc_analysis/data/ffpe_samples.txt", header = FALSE)
...
write.table(ROC.data, "/Volumes/shung/projects/gzl_targeted/roc_analysis/ROC_results-tumor_VAF_and_tumor_var_reads.txt", sep = "\t", row.names = FALSE, quote = FALSE)
```

...
write.table(ROC.data, "/Volumes/shung/projects/gzl_targeted/roc_analysis/ROC_results-FFPE-tumor_VAF_and_tumor_var_reads.txt", sep = "\t", row.names = FALSE, quote = FALSE)
```
